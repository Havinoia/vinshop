...
@section('title', 'Domain Initialization')
    ...
    <div class="glass-card rounded-[3rem] p-10 lg:p-16 relative overflow-hidden border border-slate-100 shadow-sm">
        <div class="relative z-10">
            <div class="flex items-center gap-4 mb-12">
                ...
                <h2 class="text-2xl font-black text-slate-800 tracking-tight">Initialize New Category Domain</h2>
            </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-10">
                ...
                <div class="space-y-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                           placeholder="e.g. Tactical Wearables"
                ...
                {{-- Parent Kategori --}}
                <div class="space-y-4">
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] ml-4">Hierarchy Positioning <span class="text-slate-200 font-normal ml-2">(Optional Branching)</span></label>
